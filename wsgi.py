...
<canvas id="plotarea" width="800" height="800"></canvas>
    ...
    '''
        ...
        return outstring
    #@+node:2015.20150428100013.1745: *3* spur
    @cherrypy.expose
    def index(self, K=None, N=None, inp2=None):
        # 將標準答案存入 answer session 對應區
        theanswer = random.randint(1, 100)
...
<canvas id="plotarea" width="800" height="800"></canvas>
    ...
    '''
        ...
        return outstring
    #@+node:2015.20150428100013.1749: *3* drawspur
    @cherrypy.expose
    def index(self, K=None, N=None, inp2=None):
        # 將標準答案存入 answer session 對應區
        theanswer = random.randint(1, 100)
    ...
    <form method=\"post\" action=\"drawspuraction\">
        <fieldset>
        <legend>40223150 drawspur</legend>
        齒數:<br />
        <input type=\"text\" name=\"N\"><br />
...
<canvas id="plotarea" width="800" height="800"></canvas>
    ...
    '''
        ...
        return outstring
    #@+node:2015.20150428100013.1743: *3* spuraction
    @cherrypy.expose
...
<canvas id="plotarea" width="1000" height="1000"></canvas>
    ...
    <input type=submit value=send>
        ...
        return outstring0
    #@+node:2015.20150428100013.1751: *3* drawspuraction
    @cherrypy.expose
    def doAct(self, K=None, N=None, inp2=None):
        inp3=int(N)*int(K)/2
    #inp 變數即為表單值, 其格式為字串
